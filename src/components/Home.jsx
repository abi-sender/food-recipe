...
function Home() {
  ...
  // store only recipeIds for checking favorite status in UI
  const [favorites, setFavorites] = useState([]);

  // store full favorite documents from DB for delete operation
  const [favoriteDocs, setFavoriteDocs] = useState([]);

  const navigate = useNavigate();

  // Example: get logged in user from localStorage
  ...
  const handleSearch = () => {
    const recipe = featuredRecipes.find((item) =>
        ...
        >
          <div
            className={`card border-0 shadow text-center h-100 ${
              selectedCategory === category.name ? "border border-success" : ""
            }`}
            style={{
              transition: "0.3s",
              cursor: "pointer",
      ...
      <div className="card shadow border-0 h-100">
        ...
        <div className="card-body">
          <div className="d-flex justify-content-between">
            <span className="badge bg-success">{recipe.category}</span>
...
to={`/recipe/${recipe._id}`}
     ...
     <section className="py-5 bg-light">
        <div className="container">
          <h2 className="text-center fw-bold mb-5">❤️ Favorite Recipes</h2>
    ...
    <div className="row align-items-center">
      ...
      <div className="col-lg-6">
        ...
        <p className="text-muted">
          Food Recipe is a simple and user-friendly recipe application
          designed to help everyone discover delicious meals from around
          the world. Whether you're a beginner or an experienced cook,
          you'll find recipes that are easy to prepare.
        </p>

        <p className="text-muted">
          Browse recipes by category, search for your favorite dishes,
          save recipes you love, and explore healthy, tasty meals for
          breakfast, lunch, dinner, desserts, snacks, and drinks.
        </p>
          ...
          <div className="row">
            ...
            <div className="col-md-4 mb-4">
              <div className="card shadow border-0 p-4 text-center">
                <h1>😊</h1>
                <p>
                  "Amazing recipes! Easy to cook and very delicious."
                </p>
                <h5>- Priya</h5>
              </div>
            </div>
            ...
            <div className="col-md-4 mb-4">
              <div className="card shadow border-0 p-4 text-center">
                <h1>😍</h1>
                <p>
                  "The search feature helped me quickly find recipes."
                </p>
                <h5>- Rahul</h5>
              </div>
            </div>
            ...
            <div className="col-md-4 mb-4">
              <div className="card shadow border-0 p-4 text-center">
                <h1>🤩</h1>
                <p>
                  "Beautiful design and excellent food collection."
                </p>
                <h5>- Anjali</h5>
              </div>
            </div>
...
<section id="contact" className="py-5">
        <div className="container">
          ...
          <div className="row">
           ...
           <div className="col-md-6">
  <div className="rounded shadow overflow-hidden" style={{ height: "350px" }}>
    <iframe
      title="Google Map"
          ...
          <div className="row">
            ...
            <div className="col-md-4">
              ...
              <ul className="list-unstyled">
                ...
                <li><a href="/" className="text-white text-decoration-none">Recipes</a></li>
  ...
  <div className="d-flex gap-3 fs-3">
    ...
    <a href="https://www.twitter.com" target="_blank" rel="noreferrer" className="text-light">
      <i className="bi bi-twitter-x"></i>
    </a>

    <a href="https://www.youtube.com" target="_blank" rel="noreferrer" className="text-light">
      <i className="bi bi-youtube"></i>
    </a>

    <a href="https://www.linkedin.com" target="_blank" rel="noreferrer" className="text-light">
